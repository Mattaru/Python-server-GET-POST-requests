...
# Обратите внимание: При POST-запросе вы должны ввести ВСЕ данные иначе сервер будет присылать сообщения о том
# что не все данные были введены.
# Дата выпуска альбома должна быть в интервале 1800 - 2020
# Album.sqlite3 используйте свой
